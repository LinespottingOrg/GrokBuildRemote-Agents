...
check('local open path', local.url('sessions/open') === 'http://127.0.0.1:8788/v1/sessions/open');
check('local result path', local.url('result') === 'http://127.0.0.1:8788/v1/result');
check('local lock path', local.url('lock') === 'http://127.0.0.1:8788/v1/lock');
